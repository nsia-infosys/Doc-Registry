            ...
            <form >
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="start_page_no" onChange="calculateTotalPages(this)" class="form-control" data-error="Please enter Start Page No." required />
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-md-3">
                        <label class="control-label" for="title">End Page No</label>
                        <input type="text" name="end_page_no" onChange="calculateTotalPages(this)" class="form-control" data-error="Please enter End Page No." required />
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group col-md-3">
                        <label class="control-label" for="title">Total Pages</label>
                        <input type="text" name="total_pages" class="form-control" disabled />
                    </div>
